...
// Removed chatbot_profile import for App2
...
Future<void> main() async {
  ...
  // Set app identifier for App2 (simpler version)
  await ApiService.instance.initialize(appId: 'app2');
 ...
 void _initNotifications() async {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Sathi Lite', // Different name for App2
      theme: ThemeData(
      ...
      routes: {
        ...
        // Removed ChatbotProfileScreen for App2 - goes directly to chat
